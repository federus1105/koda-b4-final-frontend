            ...
            <form>
              ...
              <div className="mb-6">
                ...
                <div className="flex items-center gap-4">
                  <img
                    src={profile.photos || placeholder}
                    alt="Profile"
              ...
              <button
                type="submit"
                className="cursor-pointer flex items-center gap-2 bg-blue-600 text-white px-6 py-3 rounded-lg font-medium hover:bg-blue-700"
              >
